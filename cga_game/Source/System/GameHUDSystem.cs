...
namespace Strategy
{
    class GameHUDSystem : IDrawSystem
    {
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(spriteFont, text, new Vector2(355, 330), Color.Black);
            spriteBatch.DrawString(spriteFont, text, new Vector2(354, 330), Color.White);
            ...
            spriteBatch.DrawString(spriteFont, score, new Vector2(355, 380), Color.Black);
            spriteBatch.DrawString(spriteFont, score, new Vector2(354, 380), Color.White);
        } 
    }
}
