...
namespace Strategy
{
    ...
    class UnitGameData
    {
        ...
        public static UnitType tank = new UnitType() { name = UnitTypeString.TANK, cost = 80, health = 200, shootTimer = 3.0f, damageDealt = 20 };
        public static UnitType plane = new UnitType() { name = UnitTypeString.PLANE, cost = 100, health = 70, shootTimer = 5.0f, damageDealt = 50 };
